...
node{
 ...
 /*  stage('Dev - Deploy Application'){
        devDeployment("${APP_NAME}-dev-apps", "${MS_NAME}")
   }*/
   ...
   stage('Test - Deploy Application'){
        testDeployment("${APP_NAME}-dev-apps", "${APP_NAME}-test-apps", "${REPO_NAME}")
   }
   ...
   stage('Tagging Image for Production'){
        openshiftTag(namespace: '$APP_NAME-dev-apps', srcStream: '$REPO_NAME', srcTag: 'latest', destStream: '$REPO_NAME', destTag: 'prod-apps')
   }	
   ...
   stage('Prod - Deploy Application'){
        prodDeployment("${APP_NAME}-dev-apps", "${APP_NAME}-prod-apps", "${REPO_NAME}")
   }	
